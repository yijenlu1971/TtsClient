...
BEGIN_MESSAGE_MAP(CTtsClientApp, CWinApp)
...
// 唯一一個 CTtsClientApp 物件

CTtsClientApp theApp;


// CTtsClientApp 初始化

BOOL CTtsClientApp::InitInstance()
{
